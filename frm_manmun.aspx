<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true"
    CodeFile="frm_manmun.aspx.cs" Inherits="frm_manmun" %>
                                ...
                                <div class="col-lg-12 col-md-12 col-sx-12 col-sm-12" style="height: 170px">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="AdmmunCodigo">Código SIS</label>
                                            <input type="text" id="AdmmunCodigo" data-esp="Código del Municipio_N_C_G_I_K" readonly="readonly"   class="text-240" disabled="disabled">
                                        </div>
                                        <div class="form-group">
                                            <label for="AdmmunMunicipio">Nombre</label>
                                            <input type="text" id="AdmmunMunicipio" data-esp="Nombre del Municipio_R_G" class="text-240">
                                        </div>
                                    </div>
                                    <div class="col">
                                        ...
                                        <div class="form-group">
                                            <label for="AdmciuCodigo">Ciudad</label>
                                            <select id="AdmciuCodigo" data-esp="Código de la Ciudad_N_R_G" class="select-240">
