<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frm_mantac.aspx.cs" Inherits="frm_mantac" %>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                &times;</button>
                            <h4 class="modal-title text-info" id="idmodal">Definir Tipo de Actividad</h4>
                        </div>
                        <!-- CUERPO ///////////////////////////////////////////// -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sx-12 col-sm-12" style="height: 170px">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="AdmTacCodigo">Código de Tipo de Actividad</label>
                                                    <input type="text" id="AdmTacCodigo" data-esp="Código de Tipo de Actividad_N_C_G_I_K" readonly="readonly" disabled="disabled" class="text-240">
                                                </div>
                                                <div class="form-group">
                                                    <label for="AdmTacDescripcion">Tipo de Actividad</label>
                                                    <input type="text" id="AdmTacDescripcion" data-esp="Tipo de Actividad_R_G" class="text-240">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
