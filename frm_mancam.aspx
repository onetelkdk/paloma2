<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frm_mancam.aspx.cs" Inherits="frm_mancam" %>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                &times;</button>
                            <h4 class="modal-title text-info" id="idmodal">Definir Cámaras</h4>
                        </div>
                        <!-- CUERPO ///////////////////////////////////////////// -->
                        <div class="modal-body">
                            <div class="col-lg-12 col-md-12 col-sx-12 col-sm-12" style="height: 155px">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="AdmcamCodigo">Código SIS</label>
                                        <input type="text" id="AdmcamCodigo" data-esp="Código de Cámara_N_C_G_I_K" readonly="readonly" disabled="disabled" class="text-240">
                                    </div>
                                    <div class="form-group">
                                        <label for="AdmcamDescripcion">Tipo de Cámara</label>
                                        <input type="text" id="AdmcamDescripcion" data-esp="Tipo de Cámara_R_G" class="text-240">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
