<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="frm_mantleg.aspx.cs" Inherits="frm_mantleg" %>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                &times;</button>
                            <h4 class="modal-title text-info" id="idmodal">Tipos de Legislaturas</h4>
                        </div>
                        <!-- CUERPO ///////////////////////////////////////////// -->
                           ...
                           <div class="col-lg-12 col-md-12 col-sx-12 col-sm-12" style="height: 165px">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="TipletCodigo">Código SIS</label>
                                        <input type="text" id="TipletCodigo" data-esp="Código Tipo de Legislatura_N_C_G_I_K" readonly="readonly" class="text-240" disabled="disabled">
                                    </div>
                                    <div class="form-group">
                                        <label for="TipletDescripcion">Descripcción</label>
                                        <input type="text" id="TipletDescripcion" data-esp="Tipo de Legislatura_R_G" class="text-240">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
