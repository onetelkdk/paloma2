<%@ Page Title="Definir Estados" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="frm_mansts.aspx.cs" Inherits="frm_mansts" %>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                &times;</button>
                            <h4 class="modal-title text-info" id="idmodal">Definir Municipios</h4>
                        </div>
                        <!-- CUERPO ///////////////////////////////////////////// -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sx-12 col-sm-12" style="height: 170px">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="admstsTabla">Nombre de la Tabla</label>
                                                    <input type="text" id="admstsTabla" data-esp="Nombre de la Tabla_N_C_G_K" readonly="readonly" disabled="disabled" class="text-240">
                                                </div>
                                                <div class="form-group">
                                                    <label for="admstsNombre">Descripcion del Estado</label>
                                                    <input type="text" id="admstsNombre" data-esp="Descripcion del Estado_R_G" class="text-240">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="admsts_codigo">Codigo del Estado</label>
                                                    <input id="admsts_codigo" data-esp="Codigo del Estado_N_R_G_C" class="text-240">
                                                </div>
                                            </div>
                            </div>
                        </div>
