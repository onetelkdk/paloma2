<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="frm_mansex.aspx.cs" Inherits="frm_mansex" %>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                &times;</button>
                            <h4 class="modal-title text-info" id="idmodal">Definir Sexo</h4>
                        </div>
                        <!-- CUERPO ///////////////////////////////////////////// -->
                           ...
                           <div class="col-lg-12 col-md-12 col-sx-12 col-sm-12" style="height: 170px">
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="Admsexcodigo">Código SIS</label>
                                                    <input type="text" id="Admsexcodigo" data-esp="Código del Sexo_C_G_K_R" class="text-240" disabled="disabled" readonly="readonly">
                                                </div>
                                                <div class="form-group">
                                                    <label for="AdmsexDescripcion">Nombre</label>
                                                    <input type="text" id="AdmsexDescripcion" data-esp="Sexo_R_G" class="text-240">
                                                </div>
                                            </div>
                                            <div class="col">
