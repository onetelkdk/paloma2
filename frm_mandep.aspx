<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true"
    CodeFile="frm_mandep.aspx.cs" Inherits="frm_mandep" %>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title text-info" id="idmodal">
                                Definir Departamentos</h4>
                        </div>
                        <!-- CUERPO ///////////////////////////////////////////// -->
                        <div class="modal-body">
                            <div class="col-lg12 col-md12 col-sm-12 col-xs-12" style="height: 230px">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="AdmdepCodigo">Código SIS</label>
                                        <input type="text" id="AdmdepCodigo" data-esp="Código Departamento_N_C_G_I_K" readonly="readonly" disabled="disabled" class="text-240">
                                    </div>
                                    <div class="form-group">     
                                        <label for="AdmdepDescripcion">Descripción</label>
                                        <textarea class="area240-2row" id="AdmdepAdmbre" data-esp="Descripción Departamento_R_G">
                                ...
                                <div class="col">
                                    <div id="dvEstado" class="form-group">
                                        <label for="Admstscodigo">Estado</label> 
                                        <select id="Admstscodigo" data-esp="Estado_R_G" class="select-240">
                                        </select>
                                    </div>
                                     <div class="form-group">
                                        <label for="AdmdepNivel">Nivel</label>
                                        <input type="text" id="AdmdepNivel" data-esp="Descripción Departamento_R_G" class="text-240">
                                    </div>     

                                    <div class="form-group">
                                        <label for="AdmdepMaster">Master</label>
                                        <input type="text" id="AdmdepMaster" data-esp="Descripción Departamento_R_G" class="text-240">
                                    </div>
                                </div>
                            </div>
                        </div>
